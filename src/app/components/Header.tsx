    ...
    <>
      ...
      <div className="sticky top-0 z-50 bg-white py-5 px-4 shadow-sm">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-center gap-3">
          ...
          {/* Scrollable nav */}
          <div className="overflow-x-auto overflow-y-hidden whitespace-nowrap scrollbar-hide">
            <div className="flex items-center justify-start lg:justify-center gap-4 w-max lg:w-full">
          ...
          {/* PINNED CART */}
          <div
            className="relative flex-shrink-0 cursor-pointer ml-1"
